...
def main(image_folder_path, config_path, checkpoint_folder, model_url, model_name, containerWidth, scalingNumber,preCalculate_file_path,start,paramNumber):
    """
...
if __name__ == "__main__":
    ...
    #TODO -- For running only certain parameter set
    # parser.add_argument(
    #     '--paramNum',
    #     type=int,
    #     default=1,
    #     help='If set a certain number, testing program will only run this paramter.'
    # )
    # Parse the arguments
    #TODO -- For running parameters in a ranage
    # parser.add_argument(
    #     '--paramRange',
    #     type=str,
    #     default=1-len(parameters),
    #     help='If set a certain number, testing program will only run this paramter.'
    # )
    # Parse the arguments
