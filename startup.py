...
def main(image_folder_path, containerWidth,config_path):
    ...
    """
    analyser = pa.ImageAnalysisModel(image_folder_path, containerWidth, config_path)
...
if __name__ == '__main__':
    ...
    parser.add_argument('containerWidth', default='180000',type=int, required=False,help='Container width in micrometers, for example, 18 cm is equal to 180000 µm.')
    parser.add_argument('config_path', type=str, default='config.ini',required=False,
