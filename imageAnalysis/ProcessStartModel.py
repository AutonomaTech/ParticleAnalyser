...
try:
    ...
    defaultScalingNumber =int( config.get(
        'analysis', 'scalingNumber', fallback=0))
...
class ProcessStartModel:
    ...
    def __init__(self, picturePath=None, sampleID=None, programNumber=None, weight=None, timestamp=None, checkpoint_folder=None):
